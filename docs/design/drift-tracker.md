...
- Postfix parity: postfix validation still needs to converge with inference/completion behavior (see `docs/design/analyzer.md` and `docs/design/builtin-fn.md`).
